...
class JovianParser {
 ...
 private:
  ...
  // clang-format off
  static constexpr size_t PRODUCTIONS_COUNT = 5;
  static std::array<Production, PRODUCTIONS_COUNT> productions_;

  static constexpr size_t ROWS_COUNT = 10;
...
auto __ = new BinaryExpression(_2, _1, _3) ;
...
auto __ = new NumericLiteral(std::stoi(_1)) ;
...
std::array<Row, yyparse::ROWS_COUNT> yyparse::table_ = {
    Row {{0, {TE::Transit, 1}}, {1, {TE::Shift, 3}}, {4, {TE::Shift, 2}}},
    Row {{2, {TE::Shift, 4}}, {3, {TE::Shift, 5}}, {6, {TE::Accept, 0}}},
    Row {{0, {TE::Transit, 8}}, {1, {TE::Shift, 3}}, {4, {TE::Shift, 2}}},
    Row {{2, {TE::Reduce, 4}}, {3, {TE::Reduce, 4}}, {5, {TE::Reduce, 4}}, {6, {TE::Reduce, 4}}},
    Row {{0, {TE::Transit, 6}}, {1, {TE::Shift, 3}}, {4, {TE::Shift, 2}}},
    Row {{0, {TE::Transit, 7}}, {1, {TE::Shift, 3}}, {4, {TE::Shift, 2}}},
    Row {{2, {TE::Reduce, 1}}, {3, {TE::Shift, 5}}, {5, {TE::Reduce, 1}}, {6, {TE::Reduce, 1}}},
    Row {{2, {TE::Reduce, 2}}, {3, {TE::Reduce, 2}}, {5, {TE::Reduce, 2}}, {6, {TE::Reduce, 2}}},
    Row {{2, {TE::Shift, 4}}, {3, {TE::Shift, 5}}, {5, {TE::Shift, 9}}},
    Row {{2, {TE::Reduce, 3}}, {3, {TE::Reduce, 3}}, {5, {TE::Reduce, 3}}, {6, {TE::Reduce, 3}}}
};
// clang-format on
